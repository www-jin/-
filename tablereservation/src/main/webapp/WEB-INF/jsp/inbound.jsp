									...
									<table class="table" id="tbRecord">
										...
										<tbody>
											<tr>
												...
												<td>${list.cName}</td>
												<td>${list.num}</td>
												<td><fmt:formatDate value="${list.time}" type="both"/></td>
												<td class="edit"><button onclick="btn_edit(${list.id})"><i class="icon-edit bigger-120"></i>出库</button></td>
												<td class="delete"><button onclick="btn_delete(${list.id})"><i class="icon-trash bigger-120"></i>删除</button></td>
											</tr>
