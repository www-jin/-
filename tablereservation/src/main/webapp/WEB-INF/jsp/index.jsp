	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">订餐管理系统</span>
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="types" target="right">
							<li>分类管理</li>
						</a>
						<a href="inventory" target="right">
							<li>库存管理</li>
						</a>
						<a href="inbound" target="right">
							<li>入库管理</li>
						</a>
						<a href="warnings" target="right">
							<li>预警信息设置</li>
						</a>
						<a href="outBouds" target="right">
							<li>出库管理</li>
						</a>
						<a href="users" target="right">
							<li>用户管理</li>
						</a>
						<a href="updatePwds" target="right"><li >修改密码</li></a>
					</ul>
				</li>
			</ul>
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="types" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
